<?php
// application/views/superadmin/Students_manage.php
    ...
    <div class="page-hero p-3 p-md-4 mb-3 aos">
      <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
        ...
        <div class="d-flex flex-wrap gap-2">
          <a href="<?php echo base_url('superadmin/fNew_Admission'); ?>" class="btn btn-primary">
  ...
  <?php endif; ?>
              ...
              <td class="text-center">
                <div class="row-actions btn-group">
                  <a href="<?php echo base_url('superadmin/student_details/'.$stu['id']); ?>" class="btn btn-ghost btn-sm" title="View"><i class="bi bi-eye"></i></a>
                  <a href="<?php echo base_url('superadmin/student_edit/'.$stu['id']); ?>" class="btn btn-ghost btn-sm" title="Edit"><i class="bi bi-pencil"></i></a>
  ...
  <?php echo $due>0
    ...
    : ' • <span class="paid-pill">Paid</span>'; ?>
        ...
        <div class="d-flex gap-2 mt-3">
          <a class="btn btn-ghost w-100" href="<?php echo base_url('superadmin/student_details/'.$stu['id']); ?>"><i class="bi bi-eye me-1"></i>View</a>
          <a class="btn btn-ghost w-100" href="<?php echo base_url('superadmin/student_edit/'.$stu['id']); ?>"><i class="bi bi-pencil me-1"></i>Edit</a>
        </div>
      </div>
    ...
    document.addEventListener('DOMContentLoaded', function(){
      document.querySelectorAll('#studentsTable tbody tr.clickable-row').forEach(tr=>{
        tr.addEventListener('click', (e)=>{
          ...
          if (id) window.location.href = '<?php echo base_url('superadmin/student_details'); ?>/'+id;
        });
      });
    });
