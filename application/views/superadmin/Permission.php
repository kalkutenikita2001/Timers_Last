                                ...
                                <div class="center-permissions mb-4">
                                    <div class="px-4 pt-4 pb-2">
                                        <h5 class="center-name mb-1">
                                            ...
                                            <?= $center['venue_name']; ?> <!-- Changed from 'name' to 'venue_name' -->
                                        </h5>
                                        <p class="text-muted small mb-0">Manage permissions for <?= $center['venue_name']; ?></p>
                                        <?php if (isset($center['location'])): ?>
                                            <p class="text-muted small mb-0">Location: <?= $center['location']; ?></p>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <form method="post" action="<?= base_url('superadmin/save_permissions/' . $center['id']) ?>" class="center-form">
                                        ...
                                        <div class="toggle-all-container d-flex justify-content-between align-items-center">
                                            <button type="submit" class="btn btn-sm btn-danger save-btn">
                                                <i class="fa fa-save me-1"></i>Save Venue Permissions
                                            </button>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        ...
        document.getElementById('globalSearch').addEventListener('input', function() {
            ...
            centers.forEach(center => {
                ...
                // Show the venue if either the venue name or any module matches
