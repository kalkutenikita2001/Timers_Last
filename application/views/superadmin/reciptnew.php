...
<head>
  ...
  <title>Renewal Receipt - Timers Academy</title>
  ...
  <style>
    /* Screen styles (visual improvements) */
    body {
    ...
    /* Print styles: fill printable width, preserve colors where possible, stack details */
    @page {
      size: A4;
      margin: 12mm;
    }
...
<body>
  <div class="receipt-container">
    ...
    <div class="receipt-details">
      <h5>Renewal Admission Receipt</h5>

      <div class="row">
        <div class="col-md-6">
          <p><span class="detail-label">Receipt No:</span> <span id="receiptNo"><?php echo htmlspecialchars($student_id); ?></span></p>
          <p><span class="detail-label">Date:</span> <span id="receiptDate"><?php echo date('Y-m-d'); ?></span></p>
          <p><span class="detail-label">Student Name:</span> <span id="studentName"></span></p>
          <p><span class="detail-label">Contact:</span> <span id="contact"></span></p>
          <p><span class="detail-label">Student Level:</span> <span id="studentLevel"></span></p>
          <p><span class="detail-label">Course Duration:</span> <span id="courseDuration"></span></p>
          <p><span class="detail-label">Parent Name:</span> <span id="parentName"></span></p>
          <p><span class="detail-label">Emergency Contact:</span> <span id="emergencyContact"></span></p>
        ...
        <div class="col-md-6">
          <p><span class="detail-label">Center:</span> <span id="center"></span></p>
          <p><span class="detail-label">Batch:</span> <span id="batch"></span></p>
          <p><span class="detail-label">Coach:</span> <span id="coach"></span></p>
          <p><span class="detail-label">Coordinator:</span> <span id="coordinator"></span></p>
          <p><span class="detail-label">Coordinator Phone:</span> <span id="coordinatorPhone"></span></p>
          <p><span class="detail-label">Batch Time:</span> <span id="batchTime"></span></p>
          <!-- <p><span class="detail-label">Duration:</span> <span id="duration"></span></p> -->
          <p><span class="detail-label">Date of Joining:</span> <span id="joiningDate"></span></p>
          <!-- <p><span class="detail-label">Attendance Link:</span> <span id="AttandanceLink"></span></p> -->
        </div>
      </div>
      ...
      <div class="text-center mt-4 no-print">
        ...
        <a href="<?= base_url('Admin/Students') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Admission</a>
      </div>
    </div>
  </div>
      ...
      if (studentId) {
        $.ajax({
          ...
          success: function(data) {
            // Fill fields (same logic as original; no functionality change)
