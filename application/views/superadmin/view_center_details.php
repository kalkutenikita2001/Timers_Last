        ...
        <form id="facilityForm">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="subtype_name" name="subtype_name" class="form-control" required placeholder="Enter Subtype Name" />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
        ...
        <form id="editFacilityForm">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="editSubtypeName" name="subtype_name" class="form-control" required placeholder="Enter Subtype Name" />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="editFacilityRent">Rent <span class="text-danger">*</span></label>
              <input type="number" id="editFacilityRent" name="facility_rent" class="form-control" min="0" step="0.01" required placeholder="Enter Rent Amount" />
            </div>
            <div class="form-group col-md-6">
        ...
        <form id="staffForm">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="contact_no" name="contact_no" class="form-control" required pattern="[0-9]{10}" placeholder="Enter 10-digit Contact Number" />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <form id="editStaffForm">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="editStaffName">Staff Name <span class="text-danger">*</span></label>
              <input type="text" id="editStaffName" name="staff_name" class="form-control" required placeholder="Enter Staff Name" />
            </div>
            <div class="form-group col-md-6">
              <label for="editContactNo">Contact Number <span class="text-danger">*</span></label>
              <input type="text" id="editContactNo" name="contact_no" class="form-control" required pattern="[0-9]{10}" placeholder="Enter 10-digit Contact Number" />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
        ...
        <form id="editExpenseForm">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="number" id="editExpenseAmount" name="expense_amount" class="form-control" min="0" step="0.01" required placeholder="Enter Amount" />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="editExpenseDescription" name="expense_description" class="form-control" placeholder="Enter Description" />
            </div>
          </div>
          <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
