<?php
// application/views/admin/Student_detail.php
...
<div class="dashboard-wrapper" id="dashboardWrapper">
  ...
  <div class="hero p-3 p-md-4 mb-3 aos">
   ...
   href="<?php echo base_url('admin/fRenewNew_Admission/'.$s['id']); ?>">
  <i class="bi bi-arrow-repeat"></i> Renew Admission
</a>
        <a href="<?php echo base_url('admin/Students'); ?>" class="btn btn-ghost">
          <i class="bi bi-arrow-left me-1"></i>Back
        </a>
        <a href="<?php echo base_url('admin/student_edit/'.$s['id']); ?>" class="btn btn-primary">
    ...
    <div class="col-lg-5 aos">
      <div class="card-lite p-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="<?php echo base_url('admin/student_fee_history/'.$s['id']); ?>" class="btn btn-ghost btn-sm">View All</a>
        </div>
        <hr class="my-3">
...
<script>
  ...
  //   // optional: keep the tiny delay for the toast animation
  //   e.preventDefault();
  ...
  //   setTimeout(function(){
  //     // navigate to fRenewNew_Admission
