...
<div class="modal fade" id="postponeModal" tabindex="-1" aria-labelledby="postponeLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <h3 id="postponeLabel">Postpone Admission</h3>
      <form id="postponeForm" novalidate>
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="postponeDate">New Date :</label>
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="postponeReason">Reason :</label>
            <textarea id="postponeReason" name="postponeReason" class="form-control" required></textarea>
...
<div class="modal fade" id="preponeModal" tabindex="-1" aria-labelledby="preponeLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <h3 id="preponeLabel">Prepone Admission</h3>
      <form id="preponeForm" novalidate>
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="preponeDate">New Date :</label>
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="preponeReason">Reason :</label>
            <textarea id="preponeReason" name="preponeReason" class="form-control" required></textarea>
...
<script>
  (function () {
    'use strict';
    const forms = ['admissionForm1', 'admissionForm2', 'admissionForm3', 'filterForm', 'editForm', 'postponeForm', 'preponeForm', 'cancelForm'].map(id => document.getElementById(id));
