...
<head>
  ...
  <style>
    ...
    .content {
      position: relative;
      margin-top: 20px; /* Matches second code */
    }
    ...
    .center-card {
      ...
      height: 250px; /* Updated to fixed height for consistency */
      min-height: 10rem;
    ...
    .navbar {
      ...
      right: 0;
      color: white;
      padding: 10px; /* Matches second code */
...
<div class="content-wrapper" id="contentWrapper">
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row justify-content-center" id="batchCards">
        <!-- Batch Cards -->
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
          <div class="center-card" id="card-1">
            ...
            <button class="view-btn" data-toggle="modal" data-target="#viewModal" data-card-id="card-1" data-batch="B1" data-date="15/07/2025" data-time="6 to 7 AM" data-category="Coach" data-group-size="6" data-coach="John Doe" data-admissions="4">View</button>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
          <div class="center-card" id="card-2">
            ...
            <button class="view-btn" data-toggle="modal" data-target="#viewModal" data-card-id="card-2" data-batch="B2" data-date="16/07/2025" data-time="7 to 8 AM" data-category="Coach" data-group-size="6" data-coach="Jane Smith" data-admissions="3">View</button>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
          <div class="center-card" id="card-3">
            ...
            <button class="view-btn" data-toggle="modal" data-target="#viewModal" data-card-id="card-3" data-batch="B3" data-date="17/07/2025" data-time="8 to 9 AM" data-category="Coach" data-group-size="6" data-coach="Mike Johnson" data-admissions="5">View</button>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
          <div class="center-card" id="card-4">
            ...
            <button class="view-btn" data-toggle="modal" data-target="#viewModal" data-card-id="card-4" data-batch="B4" data-date="18/07/2025" data-time="9 to 10 AM" data-category="Coach" data-group-size="6" data-coach="Sarah Brown" data-admissions="2">View</button>
          </div>
        </div>
      </div>
      ...
      <form id="viewBatchForm" novalidate>
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" id="viewDate" name="date" class="form-control" placeholder="DD/MM/YYYY" required />
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="viewTime" name="time" class="form-control" placeholder="H to H AM/PM" required />
...
<script>
  (function () {
    ...
    let initialCards = Array.from(document.querySelectorAll('#batchCards .col-12')).map(card => card.outerHTML);
      ...
      const newCard = `
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
          <div class="center-card" id="card-${cardCounter}">
            ...
            <button class="view-btn" data-toggle="modal" data-target="#viewModal" data-card-id="card-${cardCounter}" data-batch="${batch}" data-date="${date}" data-time="${time}" data-category="${category}" data-group-size="${groupSize}" data-coach="${coach}" data-admissions="${admissions}">View</button>
          </div>
        </div>
      `;

      // Append new card to the row
      const row = document.querySelector('#batchCards');
      if (row) {
    ...
    $('#viewModal').on('show.bs.modal', function (event) {
      ...
      modal.find('.update-btn').data('card-id', cardId);
      modal.find('.delete-btn').data('card-id', cardId);
    });
    ...
    viewForm.addEventListener('submit', function (e) {
      ...
      const cardId = $(viewForm).find('.update-btn').data('card-id');
      const batch = document.getElementById('viewBatch').value.trim();
      const date = document.getElementById('viewDate').value.trim();
      const time = document.getElementById('viewTime').value.trim();
      ...
      if (card) {
        ...
        // Update initialCards
        const cardIndex = initialCards.findIndex(c => c.includes(`id="${cardId}"`));
        if (cardIndex !== -1) {
    ...
    viewForm.querySelector('.delete-btn').addEventListener('click', function () {
      ...
      if (card) {
        ...
        // Update initialCards
        initialCards = initialCards.filter(c => !c.includes(`id="${cardId}"`));
        $('#viewModal').modal('hide');
      }
    });
