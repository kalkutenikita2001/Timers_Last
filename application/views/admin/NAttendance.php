<!-- application/views/admin/NAttendance.php (themed + single search) -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
    ...
    <div class="container-fluid">
      ...
      <div class="page-hero">
        <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
          <div>
            <div class="page-title h5 mb-0"><i class="fa-solid fa-clipboard-check me-2"></i>Student Attendance</div>
