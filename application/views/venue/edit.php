        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('venue/update/'.$venue['id']) ?>" method="POST" class="needs-validation" novalidate>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="location" 
                                       name="location" 
                                       value="<?= htmlspecialchars($venue['location']) ?>" 
                                       required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="num_courts" 
                                       name="num_courts" 
                                       value="<?= htmlspecialchars($venue['num_courts']) ?>" 
                                       min="1" 
                                       required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label">New Venue Password (Optional)</label>
